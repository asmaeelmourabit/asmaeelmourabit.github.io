        ...
        <div class="row g-0">
            <div class="col-md-6 border-end">
             	<div class="d-flex flex-column justify-content-center">
                    ...
                    <img src="{{url('./uploads/'.$details->image)}}" id="main_product_image" width="450" class="shadow">
                    </div>
                ...
                <div class="mt-2 pr-3 content">
                   ...
                   <h6><i  class="fa fa-map-marker"> {{$details->ville}}</i></h6>
                    ...
                    <span>441 reviews</span>
                     ...
                     <p class="card-text">Posted the :{{$details->date_debut}}</p>
                     </div>
                    </div>

                     <div class="buttons d-flex flex-row mt-5 gap-3">
                    <a href="#" class = "btn text-light " style="font-size: 20px;  margin-left: 300px;
                    margin-bottom: 30px; background-color: rgb(0,128,128);" >Archiver</a>
